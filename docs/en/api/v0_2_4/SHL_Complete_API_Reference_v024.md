...
7. [Provider Architecture](#7-provider-architecture)
    - [MyMemory Adapter](#MyMemoryAdapter)
    - [LibreTranslate Adapter](#LibreTranslateAdapter)
    - [DeepL Adapter](#DeepLAdapter)
    - [Google V2 Adapter](#GoogleV2Adapter)
    - [Papago Adapter](#Papago-Adapter)
...
* 4. LibreTranslate (test mode)
* 5. MyMemory (fallback, always available)
...
> Papago mapaa `formality` → `honorific`
...
# 9.1 Provider API Capabilities

| Provider          | Local Registry | Mirror Support | Built-in Failover |
| :---------------- | :------------: | :------------: | :---------------: |
| **DeepL**         |       -        |       -        |         -         |
| **Papago**        |       +        |       -        |         -         |
| **Google v2**     |       +        |       -        |         +         |
